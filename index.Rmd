...
- Usar herramientas para facilitar la redacción científica (MENDELEY).
...
cronograma <- data.frame(
  ...
  "Contenido" = c(
    ...
    "Gráfica de resultados (ggplot2)",
    " Metodología de investigación científica",
    "Planteamiento y diseño de libro de campo",
    "Colecta e importación de datos (Gsheet)",
    "Conceptos basicos de estadistica (Teoria)",
    "Modelos y diseños experimentales (Teoría)",
    "Modelos y diseños experimentales (Práctica)",
    "Modelos y diseños experimentales (Práctica)",
    "Gráfica de resultados de análisis estadísticos (ggplot2)",
    "Análisis multivariado (Teoría & Gráficos)"
